...
const S = {
  ...
  input: { width:"100%", padding:"0.7rem 0.85rem", borderRadius:10, border:"1.5px solid #e2e8f0", fontSize:14, outline:"none", boxSizing:"border-box" },
  btn:   { width:"100%", padding:"0.8rem", borderRadius:10, background:"#6366f1", color:"#fff", border:"none", fontWeight:700, fontSize:15, cursor:"pointer", marginTop:4 },
};
    ...
    <div style={S.wrap}>
      <div style={S.card}>
        <div style={{ textAlign:"center", marginBottom:"2rem" }}>
          ...
          <h1 style={{ margin:0, fontSize:24, fontWeight:800, color:"#0f172a" }}>Create account</h1>
          <p style={{ margin:"6px 0 0", color:"#64748b", fontSize:14 }}>Start tracking your job search</p>
        </div>
